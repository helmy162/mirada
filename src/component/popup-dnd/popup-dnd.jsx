...
const DnDPopup = (props) => {
  ...
  return (
    ...
    >
      ...
      <Switch onChange={() => setisChecked(!isChecked)} checked={isChecked} borderRadius={8} height={45} width={104} offColor="#F2F2F2" onColor="#F2F2F2" offHandleColor='#814486' onHandleColor="#814486" checkedIcon={<div style={{color:'#666666'}}>OFF</div>} uncheckedIcon={<div style={{color:'#666666'}}>OFF</div>} checkedHandleIcon={<div style={{color:'white'}}>OFF</div>} uncheckedHandleIcon='ON' handleDiameter={45}/>
